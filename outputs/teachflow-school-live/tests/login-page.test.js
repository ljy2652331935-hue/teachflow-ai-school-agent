...
assert.ok(studentJs.includes("AI wellbeing assistant"));
...
assert.ok(teacherJs.includes("learning support profile"));
assert.ok(teacherJs.includes("Demo teacher") || fs.readFileSync(path.join(root, "workspace-state.js"), "utf8").includes("test-teacher"));
...
assert.ok(schoolAdminJs.includes("AI school Agent System work loop"));
