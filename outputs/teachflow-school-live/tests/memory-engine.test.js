...
assert.ok(s002.weak_points.includes("visual intuition"));
...
const followup = memoryEngine.analyseMicroQuizAnswers({responses: parsedFollowup,
 analysis,
 intervention,
 existing_memories: memories});

assert.ok(followup.followup_summary.includes("Ready to apply"));
