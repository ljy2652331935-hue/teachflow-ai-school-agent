...
const teacherRegistration = store.registerTeacher({
  displayName: "Store Test Teacher",
  schoolName: "TeachFlow Store Test School",
  className: "Store Test Class",
  course: "Physics",
  topic: "Fourier transform"
});
const firstStudentRegistration = store.registerStudentWithInvite({
  inviteToken: teacherRegistration.invite.token,
  displayName: "Student A"
});
const secondStudentRegistration = store.registerStudentWithInvite({
  inviteToken: teacherRegistration.invite.token,
